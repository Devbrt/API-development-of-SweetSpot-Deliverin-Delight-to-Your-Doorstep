# Generated by Django 5.1.2 on 2024-10-15 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.cakecustomization')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='cakes',
            field=models.ManyToManyField(through='api.CartItem', to='api.cake'),
        ),
        migrations.AddField(
            model_name='cart',
            name='customer',
